...
#define OLED_CMD_SET_PAGE_START_ADDRESS 0xB0  // can be used only in PAGE mode - follow with 0x00 and 0x07 = PAGE7
...
#define OLED_CMD_SET_VCOMH_DESELECT 0xDB   // follow with 0x30
