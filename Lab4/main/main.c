...
static const char char_value[20] = "Hello";
...
static void gap_event_handler(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    case ESP_GAP_BLE_NC_REQ_EVT:
        ...
        ESP_LOGI(EXAMPLE_TAG, "ESP_GAP_BLE_NC_REQ_EVT, the passkey Notify number:%ld", param->ble_security.key_notif.passkey);
        break;
    ...
    case ESP_GAP_BLE_PASSKEY_NOTIF_EVT: /// the app will receive this evt when the IO has Output capability and the peer device IO has Input capability.
        ...
        ESP_LOGI(EXAMPLE_TAG, "The passkey notify number:%ld", param->ble_security.key_notif.passkey);
        break;
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_subscribe(client, "/mobile", 1);
...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    case ESP_GATTS_READ_EVT:
        ...
        // esp_ble_gatts_get_attr_value(param->read.handle, 10, (uint8_t **)buf);
        // printf("%s\n", *buf);
        break;
    case ESP_GATTS_WRITE_EVT:
        if (!param->write.is_prep)
        {
            ...
            sprintf(id, "%s", param->write.value);

            int msg_id = esp_mqtt_client_publish(client, "/esp32", id, 0, 1, 0);
            ESP_LOGI(TAG_MQTT, "sent publish successful, msg_id=%d", msg_id);
